  ...
  companion: {
    ...
    lines: {
      ...
      rush: [
        ...
        "Oh, you came to play today.",
        "Two locked in. The board is shaking.",
        "That is what a hot streak looks like.",
        "Greens on greens. Somebody is showing off.",
        "Two in one. Absolutely filthy guess.",
        "Pure instinct. Two greens, no hesitation.",
        "Now we are cooking with the good stuff.",
        "That guess just made the whole room jealous.",
        "Two greens deep and you are not done.",
        "Stack them up. The wall is glowing.",
        "Big brain energy, two greens, let us go.",
        "You smelled those greens from a mile away.",
